                  ...
                  <Row className="row-grid">
                    <Col lg="4">
                      <Card className="card-lift--hover shadow border-0">
                        <CardBody>
                          <h6 className="text-dark text-uppercase" style={{alignItems: "center", display: "flex"}}>
                            <i className="ni ni-calendar-grid-58 m-2" />
                            Email
                          </h6>
                          <p className="description m-2">
                            bandadecarregosa@gmail.com
                          </p>
                        </CardBody>
                      </Card>
                    </Col>
                    ...
                    <Col lg="4">
                      <Card className="card-lift--hover shadow border-0">
                        <CardBody>
                          ...
                          <p className="description m-2">
                            R. da Banda de Música 26, 3720-013
                          </p>
                        </CardBody>
                      </Card>
                    </Col>
                ...
                <Col lg="8">
                  <Card className="bg-gradient-secondary shadow">
                    <CardBody className="p-lg-5">
                      <h4 className="mb-1">Entre em contacto conosco.</h4>
                      <FormGroup
